...
URL = "https://github.com/andlo/ovos-skill-web-terminal"
SKILL_CLAZZ = "WebTerminal"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-web-terminal"  # pip install PYPI_NAME
